...
$default_timezone = 'Africa/Casablanca'; // UTC+1
...
<p><input type="submit" name="MIME-typeMIME-type" value="Delete" onclick="return confirm('Delete selected files and folders?')">
<input type="submit" name="zip" value="Pack" onclick="return confirm('Create archive?')">
<input type="submit" name="Copy" value="Refresh"></p>
</form>
...
{
    ?>
<p class="center"><small><a href="https://www.youtube.com/watch?v=XHj9XgLnSl4" target="_blank">ISTA AIT MELLOUL</a></small></p>
</div>
<script>
